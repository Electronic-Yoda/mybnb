...
public class Cli {
    private static String logged_in_user_sin = "";
    ...
    private static void handleCreateCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "user":
    ...
    private static void handleCreateUser(String[] args) {
        try {
    ...
    private static void handleCreateListing(String[] args) {
        try {
            Options options = new Options();
            options.addOption(
    ...
    private static void handleCreateBooking(String[] args) {
        try {
            Options options = new Options();
    ...
    private static void handleLoginUser(String subCommand, String[] args) {
    ...
    private static void handleLogoutUser(String subCommand, String[] args) {
        if (subCommand.equals("user")) {
    ...
    private static void handleAddCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "availability":
    ...
    private static void handleAddAvailability(String[] args) {
        try {
            Options options = new Options();
            options.addOption(Option.builder("l").longOpt("listing-id").hasArg().required().desc("listing id").build());
            options.addOption(Option.builder("sd").longOpt("startDate").hasArg().required()
    ...
    private static void handleRemoveCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "availability":
    ...
    private static void handleRemoveAvailability(String[] args) {
        try {
            Options options = new Options();
            options.addOption(Option.builder("l").longOpt("listing-id").hasArg().required().desc("listing id").build());
            options.addOption(Option.builder("sd").longOpt("startDate").hasArg().required()
    ...
    private static void handleDeleteCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "listing":
    ...
    private static void handleDeleteListing(String[] args) {
        try {
            Options options = new Options();
            options.addOption(Option.builder("l").longOpt("listing-id").hasArg().required().desc("listing id").build());
    ...
    private static void handleShowCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "mylistings":
    ...
    private static void handleShowMyListings(String[] args) {
    ...
    private static void handleShowMyBookings(String[] args) {
    ...
    private static void handleCancelCommand(String subCommand, String[] args) {
        switch (subCommand) {
            case "booking":
    ...
    private static void handleCancelBooking(String[] args) {
        try {
            Options options = new Options();
